...
const ENTITY_MANUAL = [
    ...
    { key: 'boss_crystal_colossus', char: '▲', color: '#4488ff', desc: 'Crystal Colossus (Phase 1)' },
    { key: 'boss_crystal_colossus_enraged', char: '▲', color: '#ff2222', desc: 'Crystal Colossus (Phase 2)' },
    { key: 'boss_crystal_colossus_shattered', char: '▲', color: '#ff6644', desc: 'Crystal Colossus (Phase 3)' },
    { key: 'boss_crystal_colossus_heart', char: '▲', color: '#ff0000', desc: 'Crystal Colossus (Phase 4)' },
    { key: 'boss_ancient_treant', char: '▲', color: '#22aa66', desc: 'Ancient Treant (Phase 1)' },
    { key: 'boss_ancient_treant_enraged', char: '▲', color: '#ff4400', desc: 'Ancient Treant (Phase 2)' },
    { key: 'boss_ancient_treant_uprooted', char: '▲', color: '#cc3300', desc: 'Ancient Treant (Phase 3)' },
    { key: 'boss_ancient_treant_heartwood', char: '▲', color: '#ff0000', desc: 'Ancient Treant (Phase 4)' },
    { key: 'boss_arcane_construct', char: '▲', color: '#ff8844', desc: 'Arcane Construct (Phase 1)' },
    { key: 'boss_arcane_construct_enraged', char: '▲', color: '#ff0000', desc: 'Arcane Construct (Phase 2)' },
    { key: 'boss_arcane_construct_overcharged', char: '▲', color: '#ff4400', desc: 'Arcane Construct (Phase 3)' },
    { key: 'boss_arcane_construct_meltdown', char: '▲', color: '#ff0000', desc: 'Arcane Construct (Phase 4)' },
    { key: 'boss_void_sovereign', char: '▲', color: '#7722cc', desc: 'Void Sovereign (Phase 1)' },
    { key: 'boss_void_sovereign_enraged', char: '▲', color: '#ff0000', desc: 'Void Sovereign (Phase 2)' },
    { key: 'boss_void_sovereign_unbound', char: '▲', color: '#aa00ff', desc: 'Void Sovereign (Phase 3)' },
    { key: 'boss_void_sovereign_true', char: '▲', color: '#ff00ff', desc: 'Void Sovereign (Phase 4)' },
    { key: 'boss_high_king', char: '▲', color: '#ddaa22', desc: 'High King (Phase 1)' },
