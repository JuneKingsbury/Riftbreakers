...
export const JOB_DATA = {
    ...
    // ============================================================
    // ---- Legacy / enemy-use jobs (not in the player job tree) ----
    // ---- Kept for enemy unit definitions and scenario use.    ----
    // ============================================================

    knight: {
        maxHp: 60, maxMp: 10,
        spd: 8, atk: 14, def: 10, mat: 4, mdf: 6,
        move: 3, eva: 15,
    ...
    mage: {
        maxHp: 32, maxMp: 60,
        spd: 7, atk: 6, def: 3, mat: 16, mdf: 8,
        move: 3, eva: 10,
        abilities: ['attack', 'fire', 'ice', 'thunder', 'mana_surge'],
        spriteKey: 'royal_mage',
        char: '&', color: '#f8f',
    },
    ...
    archer: {
        maxHp: 44, maxMp: 10,
        spd: 10, atk: 12, def: 5, mat: 6, mdf: 5,
        move: 4, eva: 20,
    ...
    healer: {
        maxHp: 40, maxMp: 50,
        spd: 7, atk: 7, def: 5, mat: 10, mdf: 10,
        move: 3, eva: 12,
        abilities: ['attack', 'heal', 'cure', 'regen_aura'],
        spriteKey: 'npc_ally',
        char: '+', color: '#afa',
    },
    ...
    // Orc captain shares knight's kit but is stronger and slower
    orc_captain: {
        extends: 'knight',
        maxHp: 70, maxMp: 0,
